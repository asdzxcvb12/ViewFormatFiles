...
public class FgCalculator extends Fragment {
    Context mContext;
    View view;
    ...
    int i;
    String textNum = null;
    Button[] numButtons = new Button[44];
    Integer[] numBtnIDs = { R.id.one, R.id.two, R.id.three, R.id.four, R.id.five, R.id.six, R.id.seven, R.id.eight, R.id.nine, R.id.zero,
            R.id.add, R.id.sub, R.id.mul, R.id.div, R.id.left, R.id.right, R.id.comma, R.id.minus, R.id.sin, R.id.cos, R.id.tan, R.id.xDiv,
            R.id.xDouble, R.id.doublezero, R.id.triplezero, R.id.xTriple, R.id.asin, R.id.acos, R.id.atan, R.id.sinh, R.id.cosh, R.id.tanh,
            R.id.xN, R.id.log, R.id.ln, R.id.root, R.id.abs, R.id.exp, R.id.MOD, R.id.xFac, R.id.pi, R.id.e, R.id.ppm, R.id.percent};

    public FgCalculator(Context context) {
        mContext = context;
    }
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.fgcalculator, null);

        edit = (EditText)view.findViewById(R.id.vi1);
        check = (CheckBox)view.findViewById(R.id.checkBox);
        vi1 = (EditText) view.findViewById(R.id.vi1);
        vi2 = (TextView) view.findViewById(R.id.vi2);
        text = (TextView) view.findViewById(R.id.vi3);

        cle = (Button) view.findViewById(R.id.cle);
        ...
        for(i=0; i < numBtnIDs.length; i++) {
            ...
            numButtons[index].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    String getTx = vi1.getText().toString();
                    String getBtn = numButtons[index].getText().toString();
                    String isNum = getTx + getBtn;

                    int leg = vi1.getText().toString().length();

                    if(getTx.equals("0")) {

                        if(getBtn.equals("0")) {

                        } else if(getBtn.equals("ｘ")){
                            vi1.setText(isNum);
                        ...
                        } else if(getBtn.equals("ppm")){

                        } else if(getBtn.equals("±")){
                            vi1.setText("-");
                        } else if(getBtn.equals("1/x")){
                            vi1.setText("("+getTx+")÷");
                        } else if(getBtn.equals("X²")){
                            vi1.setText(getTx+"＾2");
                        } else if(getBtn.equals("X³")){
                            vi1.setText(getTx+"＾3");
                        } else if(getBtn.equals("Xⁿ")){
                            vi1.setText(getTx+"＾");
                        } else if(getBtn.equals("X!")){
                            vi1.setText(getTx+"!");
                        } else if(getBtn.equals("ABS")){
                            vi1.setText(getBtn+"(");
                        } else {
                            vi1.setText(getBtn);
                        }
                        ...
                        if(getBtn.equals("＋")) {
                            ...
                            vi1.setText(getTx.substring(0, leg-1) + getBtn);
                        } else if (getBtn.equals("ｘ")) {
                            vi1.setText(getTx.substring(0, leg-1) + getBtn);
                        } else if (getBtn.equals("÷")) {
                            vi1.setText(getTx.substring(0, leg-1) + getBtn);
                        } else if (getBtn.equals("MOD")) {

                        } else if (getBtn.equals("EXP")) {
                    ...
                    } else if(getTx.substring(leg-1).equals("n")) {
                        if(getBtn.equals("＋")) {
                    ...
                    } else if(getTx.substring(leg-1).equals("h")) {
                        if(getBtn.equals("＋")) {
                    ...
                    } else if(getTx.substring(leg-1).equals("g")) {
                        if(getBtn.equals("＋")) {
                    ...
                    } else if(getTx.substring(leg-1).equals("m")) {
                        if(getBtn.equals("ppm")) {
                    ...
                    } else if(getTx.substring(leg-1).equals("π")) {
                        if(getBtn.equals("±")) {
                            vi1.setText(getTx + "-");
                        } else if(getBtn.equals("1/x")) {
                            vi1.setText("("+getTx+")÷");
                    ...
                    } else if(getTx.substring(leg-1).equals("Ε")) {
                        if(getBtn.equals("±")) {
                            vi1.setText(getTx + "-");
                        } else if(getBtn.equals("1/x")) {
                            vi1.setText("("+getTx+")÷");
                    ...
                    } else if(getTx.substring(leg-1).equals("P")) {
                        if(getBtn.equals("＋")) {
                    ...
                    } else if(getTx.substring(leg-1).equals("D")) {
                        if(getBtn.equals("＋")) {
        ...
        result.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                String getnum = vi1.getText().toString();
                vi2.setText(cal(getnum));
                vi1.setText("0");
            }
        });
        ...
        SharedPreferences pref = wrapper.getSharedPreferences("pref", Activity.MODE_PRIVATE);
        ...
        if(check.isChecked()) {
            String text = pref.getString("vi1", "");
            edit.setText(text);
        }
    ...
    private static String getCalculate2(String content) {
    ...
    private static String getFactorial(String content) {
    ...
    public void onStop(){
        ...
        editor.putString("vi1", edit.getText().toString());
